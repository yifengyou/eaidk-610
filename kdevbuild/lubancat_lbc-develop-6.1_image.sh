...
export BUILD_TAG="EAIDK610_lbc-develop-6.1_${set_rootfs}"
...
wget -c https://github.com/yifengyou/eaidk-610/releases/download/lubancat_lbc-develop-6.1_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/eaidk-610/releases/download/lubancat_lbc-develop-6.1_kernel/config-6.1-kdev
ls -alh config-6.1-kdev
md5sum config-6.1-kdev

wget -c https://github.com/yifengyou/eaidk-610/releases/download/lubancat_lbc-develop-6.1_kernel/System.map-6.1-kdev
ls -alh System.map-6.1-kdev
md5sum System.map-6.1-kdev

wget -c https://github.com/yifengyou/eaidk-610/releases/download/lubancat_lbc-develop-6.1_kernel/rk3399-eaidk-linux.dtb
ls -alh rk3399-eaidk-linux.dtb
md5sum rk3399-eaidk-linux.dtb

wget -c https://github.com/yifengyou/eaidk-610/releases/download/lubancat_lbc-develop-6.1_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
